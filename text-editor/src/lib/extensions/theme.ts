...
export const ui = {
	...
	".text-editor-plugin-panel": {
		fontFamily: "var(--text-editor-family-sans)",
		fontSize: "0.9em",
		borderTop: "1px solid var(--text-editor-gutter-border-color)",
		background: "var(--text-editor-gutter-fill)",
		color: "var(--text-editor-line)",
		maxHeight: "14rem",
		overflow: "auto",
	},
	".text-editor-plugin-panel .header": {
		display: "flex",
		justifyContent: "space-between",
		alignItems: "center",
		padding: "var(--studio-space-2xs, 4px) var(--studio-space-xs, 6px)",
		fontWeight: "bold",
	},
	".text-editor-plugin-panel .header button": {
		border: "none",
		background: "none",
		color: "inherit",
		cursor: "pointer",
	...
	".text-editor-plugin-panel .item": {
		display: "flex",
		alignItems: "center",
		gap: "var(--studio-space-2xs, 4px)",
		padding: "2px var(--studio-space-xs, 6px)",
		cursor: "pointer",
	},
	".text-editor-plugin-panel .id": {
		fontFamily: "var(--text-editor-family-code)",
		opacity: "0.6",
		fontSize: "0.85em",
		marginLeft: "auto",
