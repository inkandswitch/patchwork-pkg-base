...
// tells it which plugins a file of this name wants. Everything that used to be
// hand-assembled here — the keymaps, the gutters, the language grammars, the
// TypeScript environment — is now a `codemirror:extension` those ids name.
